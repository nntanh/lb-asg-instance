...
4. Provision EFS using Terraform. EFS is in 3 AZs and will be mounted into Jenkins Controller instance to keep all system files. This is to recovery when Jenkins Controller goes down and there will be another one up.
